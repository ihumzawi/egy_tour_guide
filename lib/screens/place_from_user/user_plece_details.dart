...
class UserPlaceDetails extends StatefulWidget {
  final String titel;
  ...
  @override
  State<UserPlaceDetails> createState() => _UserPlaceDetailsState();
}

class _UserPlaceDetailsState extends State<UserPlaceDetails> {
  double rating = 0;
